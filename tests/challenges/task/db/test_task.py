...
# python -m pytest tests/challenges/task/db/test_task.py::test_get_ok -v -s
@pytest.mark.asyncio
...
# python -m pytest tests/challenges/task/db/test_task.py::test_get_task_not_found -v -s
@pytest.mark.asyncio
...
# python -m pytest tests/challenges/task/db/test_task.py::test_get_not_translate -v -s
@pytest.mark.asyncio
...
# python -m pytest tests/challenges/task/db/test_task.py::test_lst -v -s
@pytest.mark.asyncio
