...
# pytest tests/tmain/usecase/test_occypancy_category.py::test_category_get_ok -v -s
@pytest.mark.asyncio
...
# pytest tests/tmain/usecase/test_occypancy_category.py::test_category_list_ok -v -s
@pytest.mark.asyncio
