...
# pytest tests/main/challenges/task/db/test_user_task.py::test_get_user_task_not_found -v -s
@pytest.mark.asyncio
...
# pytest tests/main/challenges/task/db/test_user_task.py::test_create_user_task_not_created -v -s
@pytest.mark.asyncio
...
# pytest tests/main/challenges/task/db/test_user_task.py::test_update_user_task -v -s
@pytest.mark.asyncio
...
# pytest tests/main/challenges/task/db/test_user_task.py::test_update_user_task_not_found -v -s
@pytest.mark.asyncio
