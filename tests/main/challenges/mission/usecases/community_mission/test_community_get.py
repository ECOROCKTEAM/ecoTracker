...
# pytest tests/main/challenges/mission/usecases/community_mission/test_community_get.py::test_ok -v -s
@pytest.mark.asyncio
async def test_ok(
    uow: IUnitOfWork,
...
# pytest tests/main/challenges/mission/usecases/community_mission/test_community_get.py::test_user_blocked_in_community -v -s
@pytest.mark.asyncio
...
# pytest tests/main/challenges/mission/usecases/community_mission/test_community_get.py::test_community_not_active -v -s
@pytest.mark.asyncio
