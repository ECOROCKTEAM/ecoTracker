...
# pytest tests/challenges/task/usecases/task_user/test_user_add.py::test_ok -v -s
@pytest.mark.asyncio
async def test_ok(
    uow: IUnitOfWork,
...
# pytest tests/challenges/task/usecases/task_user/test_user_add.py::test_user_task_already_usage -v -s
@pytest.mark.asyncio
...
# pytest tests/challenges/task/usecases/task_user/test_user_add.py::test_user_not_premium_max_amount_error -v -s
@pytest.mark.asyncio
...
# pytest tests/challenges/task/usecases/task_user/test_user_add.py::test_user_not_premium_max_amount -v -s
@pytest.mark.asyncio
...
# pytest tests/challenges/task/usecases/task_user/test_user_add.py::test_user_premium_max_amount_error -v -s
@pytest.mark.asyncio
...
# pytest tests/challenges/task/usecases/task_user/test_user_add.py::test_user_premium_max_amount -v -s
@pytest.mark.asyncio
...
# pytest tests/challenges/task/usecases/task_user/test_user_add.py::test_user_plan_premium_max_amount_error -v -s
@pytest.mark.asyncio
...
# pytest tests/challenges/task/usecases/task_user/test_user_add.py::test_user_plan_not_premium_max_amount_error -v -s
@pytest.mark.asyncio
...
# pytest tests/challenges/task/usecases/task_user/test_user_add.py::test_user_plan_premium_max_amount -v -s
@pytest.mark.asyncio
...
# pytest tests/challenges/task/usecases/task_user/test_user_add.py::test_user_plan_not_premium_max_amount -v -s
@pytest.mark.asyncio
