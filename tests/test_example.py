...
from src.data.models.shared.occupancy import OccupancyStatusModel, OccupancyCategoryModel
from src.data.models.translate.task import TaskTranslateModel
from src.data.models.translate.occupancy import OccupancyStatusTranslateModel, OccupancyCategoryTranslateModel
