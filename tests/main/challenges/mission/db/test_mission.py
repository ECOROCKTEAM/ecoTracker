...
# pytest tests/main/challenges/mission/db/test_mission.py::test_get_ok -v -s
@pytest.mark.asyncio
...
# pytest tests/main/challenges/mission/db/test_mission.py::test_get_mission_not_found -v -s
@pytest.mark.asyncio
...
# pytest tests/main/challenges/mission/db/test_mission.py::test_get_not_translate -v -s
@pytest.mark.asyncio
...
# pytest tests/main/challenges/mission/db/test_mission.py::test_lst -v -s
@pytest.mark.asyncio
...
# pytest tests/main/challenges/mission/db/test_mission.py::test_lst_filter -v -s
@pytest.mark.asyncio
