...
# pytest tests/main/challenges/task/db/test_plan_task.py::test_plan_create -v -s
@pytest.mark.asyncio
...
# pytest tests/main/challenges/task/db/test_plan_task.py::test_not_created -v -s
@pytest.mark.asyncio
...
# pytest tests/main/challenges/task/db/test_plan_task.py::test_plan_delete -v -s
@pytest.mark.asyncio
...
# pytest tests/main/challenges/task/db/test_plan_task.py::test_plan_not_delete -v -s
@pytest.mark.asyncio
