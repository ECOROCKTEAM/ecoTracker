...
class TaskCreateUseCase:
    ...
    async def __call__(self, *, updating_user: User, admin_user: User, obj: UserRoleDTO) -> Result:
        ...
        user = UserUserRoleUpdateDTO(username=updating_user.username, application_role=obj.name)
