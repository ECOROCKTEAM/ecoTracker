...
# pytest tests/main/challenges/mission/usecases/community_mission/test_community_create.py::test_ok -v -s
@pytest.mark.asyncio
async def test_ok(
    uow: IUnitOfWork,
...
# pytest tests/main/challenges/mission/usecases/community_mission/test_community_create.py::test_user_incorrect_role -v -s
@pytest.mark.asyncio
...
# pytest tests/main/challenges/mission/usecases/community_mission/test_community_create.py::test_community_not_active -v -s
@pytest.mark.asyncio
...
# pytest tests/main/challenges/mission/usecases/community_mission/test_community_create.py::test_mission_not_active -v -s
@pytest.mark.asyncio
