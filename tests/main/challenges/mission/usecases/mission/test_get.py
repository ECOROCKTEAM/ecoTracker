...
# pytest tests/main/challenges/mission/usecases/mission/test_get.py::test_ok -v -s
@pytest.mark.asyncio
async def test_ok(
    uow: IUnitOfWork,
...
# pytest tests/main/challenges/mission/usecases/mission/test_get.py::test_not_active -v -s
@pytest.mark.asyncio
