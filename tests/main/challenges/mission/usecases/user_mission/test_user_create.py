...
# pytest tests/main/challenges/mission/usecases/user_mission/test_user_create.py::test_ok -v -s
@pytest.mark.asyncio
async def test_ok(
    uow: IUnitOfWork,
...
# pytest tests/main/challenges/mission/usecases/user_mission/test_user_create.py::test_not_active -v -s
@pytest.mark.asyncio
