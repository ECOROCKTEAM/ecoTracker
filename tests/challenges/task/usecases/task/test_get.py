...
# python -m pytest tests/challenges/task/usecases/task/test_get.py::test_ok -v -s
@pytest.mark.asyncio
async def test_ok(
    uow: IUnitOfWork,
...
# python -m pytest tests/challenges/task/usecases/task/test_get.py::test_not_active -v -s
@pytest.mark.asyncio
